...
public interface ProductLocalHome extends EJBLocalHome {
     ...
     */
    Collection<ProductLocal> findAll()
            throws FinderException;
     ...
     * @throws FinderException if query fails
     */
    Collection<ProductLocal> findByCategory(String category)
            throws FinderException;
     ...
     * @throws FinderException if query fails
     */
    Collection<ProductLocal> findByPriceLessThan(BigDecimal maxPrice)
            throws FinderException;
     ...
     * @throws FinderException if query fails
     */
    Collection<ProductLocal> findInStock()
            throws FinderException;
}
