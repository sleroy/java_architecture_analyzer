package br.com.semeru.soap.client;

import br.com.semeru.soap.CalculatorWebService;
import br.com.semeru.soap.MemberWebService;
import br.com.semeru.soap.dto.MemberListResponse;
import br.com.semeru.soap.dto.MemberRequest;
import br.com.semeru.soap.dto.MemberResponse;
...
public class SoapClientExample {
    ...
    private static final String MEMBER_WSDL_URL = "http://localhost:8080/semeru-ejb-maven-web/MemberWebService?wsdl";
    private static final String CALCULATOR_WSDL_URL = "http://localhost:8080/semeru-ejb-maven-web/CalculatorWebService?wsdl";
    
    // Target namespace from web service
    private static final String TARGET_NAMESPACE = "http://soap.semeru.com.br/";
