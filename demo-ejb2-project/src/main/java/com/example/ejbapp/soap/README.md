...
This directory contains SOAP (Simple Object Access Protocol) web service controllers for the Unicorn EJB Maven application.
...
**WSDL Location**: `http://localhost:8080/demo-ejb2-project/MemberWebService?wsdl`
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" 
                  xmlns:soap="http://soap.ejbapp.example.com/">
   <soapenv:Header/>
   <soapenv:Body>
      <soap:registerMember>
         <memberRequest>
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
   <soap:Body>
      <ns2:registerMemberResponse xmlns:ns2="http://soap.ejbapp.example.com/">
         <memberResponse>
...
**WSDL Location**: `http://localhost:8080/demo-ejb2-project/CalculatorWebService?wsdl`
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
   <soap:Body>
      <ns2:addResponse xmlns:ns2="http://soap.ejbapp.example.com/">
...
@WebService(
    ...
    targetNamespace = "http://soap.ejbapp.example.com/"
)
```
...
curl -X POST http://localhost:8080/demo-ejb2-project/MemberWebService \
  ...
  -d '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:soap="http://soap.ejbapp.example.com/">
   <soapenv:Header/>
   <soapenv:Body>
      <soap:registerMember>
         <memberRequest>
...
```java
// Create service
URL wsdlURL = new URL("http://localhost:8080/demo-ejb2-project/MemberWebService?wsdl");
QName serviceName = new QName("http://soap.ejbapp.example.com/", "MemberWebService");
...
<servlet>
    ...
    <servlet-class>soap.com.example.ejbapp.MemberWebServiceImplcom.example.ejbapp.soap.MemberWebServiceImpl</servlet-class>
</servlet>
<servlet-mapping>
<servlet-name>MemberWebService</servlet-name>
...
- Member Service: `http://localhost:8080/demo-ejb2-project/MemberWebService?wsdl`
- Calculator Service: `http://localhost:8080/demo-ejb2-project/CalculatorWebService?wsdl`
