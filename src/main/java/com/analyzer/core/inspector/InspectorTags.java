...
public final class InspectorTags {
    ...
    // ==================== RESOURCE AVAILABILITY TAGS ====================

    /**
     * Tag indicating if Java source is available for this resource
     */
    public static final String RESOURCE_HAS_JAVA_SOURCE = "resource.has_java_source";
    ...
    /**
     * Tag for general file type classification
     */
    ...
    /**
     * Common file type: Java source file
     */
    public static final String FILE_TYPE_JAVA_SOURCE = "java_source";

    /**
     * Common file type: Java class file
     */
    public static final String FILE_TYPE_JAVA_CLASS = "java_class";
