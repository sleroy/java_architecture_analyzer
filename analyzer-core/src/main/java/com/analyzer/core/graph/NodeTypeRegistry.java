...
public enum NodeTypeRegistry {
     ...
     */
    public static void register(final Class<? extends GraphNode> nodeClass, final String typeId, final NodeFactory factory) {
     ...
     * @param factory The factory for creating instances of this node type
     */
    public static void registerFactory(final String typeId, final NodeFactory factory) {
        FACTORY_MAP.put(typeId, factory);
    }
     ...
     */
    public static String getTypeId(final Class<? extends GraphNode> nodeClass) {
     ...
     * @return The type identifier, or "unknown" if not registered
     */
    public static String getTypeId(final GraphNode node) {
        if (node == null) {
            return "unknown";
        }
     ...
     */
    public static boolean isRegistered(final Class<? extends GraphNode> nodeClass) {
    ...
    public static Optional<Class<? extends GraphNode>> findClassByTypeId(final String typeId) {
