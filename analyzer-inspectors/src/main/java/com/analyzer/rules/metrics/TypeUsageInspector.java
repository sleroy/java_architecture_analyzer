 ...
 * return types, exception types, annotation types, and generic type parameters.
 * It provides detailed
 * metrics about type dependencies, complexity, and framework integration
 * patterns.
 * </p>
 * 
 * <p>
 * The inspector uses a multi-approach analysis strategy:
 * </p>
 * <ul>
 * <li><strong>ClassLoader Analysis</strong> (Primary): Runtime reflection for
 * complete type information</li>
 * <li><strong>ASM Enhancement</strong> (Detailed): Bytecode inspection for
 * method signatures</li>
 * <li><strong>JavaParser Enhancement</strong> (Source): Source code parsing for
 * imports and local variables</li>
 * </ul>
 * 
 * <p>
 ...
 */
@InspectorDependencies(requires = { InspectorTags.TAG_JAVA_DETECTED, InspectorTags.TAG_APPLICATION_CLASS }, produces = { "types.total_unique" })
public class TypeUsageInspector extends AbstractClassLoaderBasedInspector {
     ...
     */
    @Inject
    public TypeUsageInspector(ResourceResolver resourceResolver,
     ...
     */
    private TypeUsageMetrics analyzeTypeUsage(Class<?> clazz, ProjectFile projectFile) {
